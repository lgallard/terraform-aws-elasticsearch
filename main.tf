...
locals {
  ...
  duration = var.auto_tune_options && lookup(lookup(var.auto_tune_options, "maintenance_schedule", null), "duration", null) != null ? lookup(lookup(var.auto_tune_options, "maintenance_schedule"), "duration") : {
